...
8. Добавить в текущий результат после feature несвязанные с multi-profile изменения: подавление update checks, переход тестовых fixtures с `8.5.1` на `8.3.27`, удаление 8.5-specific form XML и версию `1.0.3`.
