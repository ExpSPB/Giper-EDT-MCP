...
EDT **Help → Check for Updates** / Install New Software compares OSGi `major.minor.micro`. Maven `1.0.2-SNAPSHOT` becomes `1.0.2.qualifier`; a qualifier-only rebuild is **not** an update. **Always bump the micro** (`1.0.2` → `1.0.3-SNAPSHOT`) when the installed plugin must pick up new bits:
