...
public class WriteScopeInventoryTest
{
    ...
    private static final Set<String> CLASSIFIED = new HashSet<>(Arrays.asList(
        ...
        "fm.giper.edt.mcp.server.tools.impl.CreateMetadataTool", //$NON-NLS-1$
        "fm.giper.edt.mcp.server.tools.impl.ModifyMetadataTool", //$NON-NLS-1$
        ...
        "fm.giper.edt.mcp.server.tools.impl.AdoptMetadataObjectTool", //$NON-NLS-1$
        "fm.giper.edt.mcp.server.tools.impl.ResyncToDiskTool", //$NON-NLS-1$
        "fm.giper.edt.mcp.server.tools.impl.DeleteMetadataTool", //$NON-NLS-1$
        ...
        "fm.giper.edt.mcp.server.tools.impl.ApplyQuickFixTool")); //$NON-NLS-1$
