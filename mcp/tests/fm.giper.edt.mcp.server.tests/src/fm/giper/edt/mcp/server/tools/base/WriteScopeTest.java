...
public class WriteScopeTest
{
    ...
    {
        WriteScope scope = new WriteScope();
        String refusal = fm.giper.edt.mcp.server.protocol.ToolResult.error("later step failed").toJson(); //$NON-NLS-1$
    ...
    public void testAnOpaqueWriterMarksUnknownWithoutClaimingACommit()
    {
        ...
        String refusal = fm.giper.edt.mcp.server.protocol.ToolResult.error("fix threw").toJson(); //$NON-NLS-1$
