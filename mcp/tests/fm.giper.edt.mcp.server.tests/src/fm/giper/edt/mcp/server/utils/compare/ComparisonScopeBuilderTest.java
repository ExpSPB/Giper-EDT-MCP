...
import fm.giper.edt.mcp.server.utils.compare.ComparisonScopeBuilder.Scoping;
...
public class ComparisonScopeBuilderTest
{
    ...
    public void testAFinishedRunIsNotDescribedByAskingThisPredicateAgain()
    {
        ...
        ComparisonScopeTestSupport.extendScope(launchedGlobal, "Catalog.PulledIn", "referenced by a compared object", //$NON-NLS-1$ //$NON-NLS-2$
            ComparisonSide.MAIN);
