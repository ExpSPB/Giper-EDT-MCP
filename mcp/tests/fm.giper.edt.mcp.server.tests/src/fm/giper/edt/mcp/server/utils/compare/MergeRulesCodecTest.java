...
import fm.giper.edt.mcp.server.utils.compare.MergeRulesDocument.Element;
...
public class MergeRulesCodecTest
{
    ...
    private static final String GUIDE =
        "mcp/bundles/fm.giper.edt.mcp.server/guides/merge_rules.md"; //$NON-NLS-1$
    ...
    private static final String CODEC_SOURCE = "mcp/bundles/fm.giper.edt.mcp.server/src/fm/" //$NON-NLS-1$
        + "giper/edt/mcp/server/utils/compare/MergeRulesCodec.java"; //$NON-NLS-1$
