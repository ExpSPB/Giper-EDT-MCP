...
import fm.giper.edt.mcp.server.tools.rename.MetadataRenameService;
import fm.giper.edt.mcp.server.tools.rename.RenameProgress;
 ...
 * (as {@link fm.giper.edt.mcp.server.protocol.ToolResult#error} JSON payloads)
