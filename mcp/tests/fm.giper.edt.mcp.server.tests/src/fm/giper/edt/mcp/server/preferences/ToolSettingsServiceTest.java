...
public class ToolSettingsServiceTest
{
    ...
    /*
     * Version 6 - the debug_launch -> launch rename. A deliberate disable is a user decision, so it
    ...
    @Test
    public void testVersion6RenamesADeliberatelyDisabledDebugLaunch()
    {
        PreferenceStore store = storedDisabledTools(
            Set.of("debug_launch", "git", "ask_workmate"), 5); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    @Test
    public void testVersion6RenameKeepsAHistoricalCodeReviewStoreRecognized()
    {
    ...
    @Test
    public void testVersion6DoesNotDisableLaunchForAStoreThatNeverDisabledIt()
    {
