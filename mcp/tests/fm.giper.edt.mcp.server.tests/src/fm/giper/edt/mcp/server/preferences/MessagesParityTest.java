...
public class MessagesParityTest
{
    ...
    private static final String PREFS_EN = "fm/giper/edt/mcp/server/preferences/messages.properties"; //$NON-NLS-1$
    private static final String PREFS_RU = "fm/giper/edt/mcp/server/preferences/messages_ru.properties"; //$NON-NLS-1$
    private static final String TAGS_EN = "fm/giper/edt/mcp/server/tags/ui/messages.properties"; //$NON-NLS-1$
    private static final String TAGS_RU = "fm/giper/edt/mcp/server/tags/ui/messages_ru.properties"; //$NON-NLS-1$
    private static final String HISTORY_EN = "fm/giper/edt/mcp/server/ui/messages.properties"; //$NON-NLS-1$
    private static final String HISTORY_RU = "fm/giper/edt/mcp/server/ui/messages_ru.properties"; //$NON-NLS-1$
    ...
    private static final String[] MESSAGES_CLASSES = {
        "fm.giper.edt.mcp.server.preferences.Messages", //$NON-NLS-1$
        "fm.giper.edt.mcp.server.tags.ui.Messages", //$NON-NLS-1$
        "fm.giper.edt.mcp.server.ui.Messages" //$NON-NLS-1$
    };
