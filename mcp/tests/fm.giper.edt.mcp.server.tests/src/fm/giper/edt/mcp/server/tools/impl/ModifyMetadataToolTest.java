...
public class ModifyMetadataToolTest
{
    ...
    {
        fm.giper.edt.mcp.server.utils.XdtoWriter.MemberRef ref =
            fm.giper.edt.mcp.server.utils.XdtoWriter.parseMemberRef("XDTOPackage.MyPackage.ObjectType.Missing"); //$NON-NLS-1$
        assertNotNull(ref);
    ...
    {
        fm.giper.edt.mcp.server.utils.XdtoWriter.MemberRef packageGlobal =
            fm.giper.edt.mcp.server.utils.XdtoWriter.parseMemberRef("XDTOPackage.MyPackage.Property.Missing"); //$NON-NLS-1$
        ...
        fm.giper.edt.mcp.server.utils.XdtoWriter.MemberRef nested = fm.giper.edt.mcp.server.utils.XdtoWriter
    ...
    public void testModifyMemberLookupToleratesYoSpelledObjectTypeName()
    {
        ...
        assertEquals("modifyXdtoMemberInTx's own target resolution must tolerate a yo-spelled FQN segment", //$NON-NLS-1$
            type, fm.giper.edt.mcp.server.utils.XdtoWriter.findObjectType(pkg, yoSpelledName));
    }
