...
public class BmTransactionsTest
{
    ...
    public void testForceExportToDiskRecordsTheProjectIntoTheCallsWriteScope()
    {
        ...
        fm.giper.edt.mcp.server.tools.base.WriteScope scope =
            new fm.giper.edt.mcp.server.tools.base.WriteScope();
        fm.giper.edt.mcp.server.tools.base.WriteScope.runWithScope(scope,
