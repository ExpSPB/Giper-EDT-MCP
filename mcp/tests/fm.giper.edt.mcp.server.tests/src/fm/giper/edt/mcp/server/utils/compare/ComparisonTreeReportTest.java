...
import fm.giper.edt.mcp.server.utils.compare.ComparisonScopeTestSupport;
...
public class ComparisonTreeReportTest
{
    ...
    public void testRequestedScopeIsNeverTheEngineExtendedScope()
    {
        ...
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by " + CATALOG_GOODS, //$NON-NLS-1$
            ComparisonSide.MAIN);
        ...
        if (ComparisonScopeTestSupport.extendedScopeCarriesReasons())
        {
    ...
    public void testTheReasonsTheEngineGivesAreCutAtTheLimitLikeTheCellTheyExplain()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ComparisonScopeTestSupport.extendScope(scope, "Catalog.Pulled" + i, "referenced by " + CATALOG_GOODS, //$NON-NLS-1$ //$NON-NLS-2$
                ComparisonSide.MAIN);
        }
    ...
    public void testAnEngineReasonCannotAddABulletToTheReport()
    {
        ...
        ComparisonScope scope = new ComparisonScope(Collections.singletonList(CATALOG_GOODS),
            Collections.singletonList(CATALOG_GOODS), Collections.singletonList(CATALOG_GOODS));
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by X\n- forged bullet", //$NON-NLS-1$
            ComparisonSide.MAIN);
    ...
    {
        Assume.assumeTrue("per-name reasons exist only on EDT builds after 2025.2", //$NON-NLS-1$
            ComparisonScopeTestSupport.extendedScopeCarriesReasons());
        ComparisonScope scope = new ComparisonScope(Collections.singletonList(CATALOG_GOODS),
            Collections.singletonList(CATALOG_GOODS), Collections.singletonList(CATALOG_GOODS));
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by " + CATALOG_GOODS, //$NON-NLS-1$
            ComparisonSide.MAIN);
    ...
    public void testTheReasonCountCoversEverySideTheEngineExtended()
    {
        ComparisonScope scope = new ComparisonScope(Collections.singletonList(CATALOG_GOODS),
            Collections.singletonList(CATALOG_GOODS), Collections.singletonList(CATALOG_GOODS));
        ComparisonScopeTestSupport.extendScope(scope, "Catalog.PulledA", "referenced by " + CATALOG_GOODS, //$NON-NLS-1$ //$NON-NLS-2$
            ComparisonSide.MAIN);
        ComparisonScopeTestSupport.extendScope(scope, "Catalog.PulledB", "referenced by " + CATALOG_GOODS, //$NON-NLS-1$ //$NON-NLS-2$
            ComparisonSide.MAIN);
        ComparisonScopeTestSupport.extendScope(scope, "Catalog.PulledC", "referenced by " + CATALOG_GOODS, //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testTheReasonsForOneAddedNameAreCutAtTheLimitToo()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by Catalog.Asking" + i, //$NON-NLS-1$
                ComparisonSide.MAIN);
        }
    ...
    public void testAListOfReasonsThatFitsCarriesNoTruncationNotice()
    {
        ...
        ComparisonScope scope = new ComparisonScope(Collections.singletonList(CATALOG_GOODS),
            Collections.singletonList(CATALOG_GOODS), Collections.singletonList(CATALOG_GOODS));
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by Catalog.AskingA", //$NON-NLS-1$
            ComparisonSide.MAIN);
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, "referenced by Catalog.AskingB", //$NON-NLS-1$
            ComparisonSide.MAIN);
    ...
    {
        String root = "mcp/bundles/fm.giper.edt.mcp.server/src/fm/giper/edt/mcp/server/"; //$NON-NLS-1$
    ...
    public void testAnEngineExtendedWholeConfigurationRunStillCarriesNoContentCaveat()
    {
        ...
        ComparisonScopeTestSupport.extendScope(scope, "Catalog.PulledIn", "referenced by a compared object", //$NON-NLS-1$ //$NON-NLS-2$
            ComparisonSide.MAIN);
    ...
    public void testACopiedScopeDoesNotGrowWithTheEngine()
    {
        ...
        ComparisonScopeTestSupport.extendScope(scope, DOCUMENT_ORDER, LATE_NAME_REASON, ComparisonSide.MAIN);
        ComparisonScopeTestSupport.extendScope(scope, CATALOG_WAREHOUSES, LATE_EXTRA_REASON, ComparisonSide.MAIN);
