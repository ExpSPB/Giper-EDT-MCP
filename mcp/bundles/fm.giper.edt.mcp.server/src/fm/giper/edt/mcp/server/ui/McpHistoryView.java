...
import fm.giper.edt.mcp.server.history.StatsAggregator;
import fm.giper.edt.mcp.server.history.StatsAggregator.StatsResult;
import fm.giper.edt.mcp.server.history.ToolStats;
...
public class McpHistoryView extends ViewPart implements McpCallHistory.HistoryListener
{
    ...
    public static final String ID = "fm.giper.edt.mcp.server.history.historyView"; //$NON-NLS-1$
