 ...
 *
 * @see fm.giper.edt.mcp.server.preferences.PreferenceConstants#PREF_DESTRUCTIVE_CONSENT_LEVEL
 * @see fm.giper.edt.mcp.server.preferences.PreferenceConstants#PREF_DESTRUCTIVE_ALLOWED_TOOLS
 */
