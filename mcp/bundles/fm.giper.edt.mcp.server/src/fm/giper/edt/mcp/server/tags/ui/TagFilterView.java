...
import fm.giper.edt.mcp.server.tags.TagService.ITagChangeListener;
...
public class TagFilterView extends ViewPart implements ITagChangeListener {
    ...
    public static final String ID = "fm.giper.edt.mcp.server.tags.filterView";
    ...
    private void navigateToObject(IProject project, String fqn) {
        ...
        try {
            ...
            org.eclipse.emf.ecore.EObject targetObject = (org.eclipse.emf.ecore.EObject)
                fm.giper.edt.mcp.server.utils.BmTransactions.<com._1c.g5.v8.bm.core.IBmObject>read(
