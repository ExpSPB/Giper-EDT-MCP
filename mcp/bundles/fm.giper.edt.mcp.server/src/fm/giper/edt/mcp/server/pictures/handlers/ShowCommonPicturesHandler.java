...
package fm.giper.edt.mcp.server.pictures.handlers;
...
import fm.giper.edt.mcp.server.pictures.CommonPicturesGalleryRenderer;
import fm.giper.edt.mcp.server.pictures.CommonPicturesGalleryRenderer.RenderedPage;
import fm.giper.edt.mcp.server.pictures.editor.StringHtmlEditorInput;
import fm.giper.edt.mcp.server.utils.EditorScreenshotHelper;
 ...
 * like {@link fm.giper.edt.mcp.server.groups.handlers.NewGroupHandler#isCollectionAdapter}, it walks
...
public class ShowCommonPicturesHandler extends AbstractHandler
{
    ...
    private static final String GALLERY_EDITOR_ID = "fm.giper.edt.mcp.server.pictures.galleryEditor"; //$NON-NLS-1$
