...
package fm.giper.edt.mcp.server.tags.handlers;
...
public class ToggleTagByIndexHandler extends AbstractTagHandler {
     ...
     */
    public static final String COMMAND_ID = "fm.giper.edt.mcp.server.tags.toggleTag";
    
    /**
     * Command parameter ID for the tag index (1-10, where 10 is represented as 0).
     */
    public static final String PARAM_TAG_INDEX = "fm.giper.edt.mcp.server.tags.toggleTag.index";
